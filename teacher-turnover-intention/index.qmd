...
- **Age**: Median age is 29 years (IQR: 26–32), this indicates a relatively young workforce, mostly in their late 20s to early 30s, suggesting early-career professionals are associated with jobs related to online ESL.

- **Gender**: The ESL teaching workforce is female-dominated, which may influence workplace dynamics, perceptions of job satisfaction, and turnover intentions.

- **Employment status**: Only 2 respondents (1.8%) reported mixed status. The resut shows a balanced split between full-time and part-time teachers, which could affect workload, income stability, and turnover risk.

- **Weekly Teaching Hours**: Median teaching hours is 37 hours (IQR: 20–40), this suggests that many teachers are working near full-time hours, even among part-timers, which may contribute to stress or job satisfaction issues.

- **Years of Experience**: In terms of years of experience, the exeperience is 2 years (IQR: 1–3.5). This points to a relatively new workforce, with limited long-term tenure. High turnover risk is common in early-career stages.

- **Monthly Income**: The median monthly income among respondent is ₱17,000 (IQR: ₱12,000–₱25,000). This income range is modest compared to professional teaching roles, which may influence job satisfaction and turnover intentions.
:::
...
- Teams dominates the ESL teaching landscape, suggesting strong institutional adoption.

- The variety of platforms may suggest that teachers often adapt to employer requirements rather than choosing platforms themselves. The long tail of niche platforms reflects regional diversity and company-specific preferences.
:::
...
- Overall happiness is very strong, with 57% strongly agreeing and 31% agreeing that they are happy with their current ESL teaching job. Only 3% expressed dissatisfaction, while 10% were neutral. This reinforces the finding that teachers generally feel positive about their work, with happiness levels aligning closely with satisfaction and motivation indicators.
...
- A strong majority of teachers report possessing strong English communication skills, with 61% strongly agreeing and 30% agreeing. Only 3% expressed disagreement, while 7% remained neutral. This indicates that English proficiency is a clear strength among ESL teachers.
...
Before running Partial Least Squares Structural Equation Modeling (PLS-SEM), it is essential to know which survey items belong to which latent constructs. PLS-SEM assumes that the measurement model—the way items form factors—is already well-defined. If we assign items incorrectly, the SEM results may be misleading.
...
A scree plot with parallel analysis (Figure below) is a tool used in Exploratory Factor Analysis (EFA) to decide how many factors to keep. The result shows that there are potential 3-4 factors that can be extracted instead of five factors as expected.
...
Using the EFA, resukt shows that items from Job attributes and Workplace perceptions loaded strongly on the same factor. This means that, statistically, respondents did not distinguish between these two categories—they saw them as part of a single underlying dimension.

For example, perceptions of fair salary, manageable workload, and supportive workplace policies all clustered together. This suggests that teachers view their job conditions and workplace environment as one combined construct, rather than two separate ones.
:::
...
print(efa_extract$loadings, cutoff = 0.4, sort = TRUE)
```
...
This path is positive and significant. Teachers who report stronger skills, confidence, and adaptability tend to have higher job satisfaction. The effect size is moderate, and the confidence interval [0.118, 0.526] confirms robustness. This means teacher qualities directly enhance satisfaction with their work.
:::


::: {.callout-caution}
## Teacher attributes → Turnover intention (β = 0.238, p = 0.048)
This path is positive and significant, though weaker. Interestingly, stronger teacher attributes are associated with a higher likelihood of turnover intention. One possible explanation is that more capable teachers feel confident in their skills and may be more willing to explore better opportunities elsewhere. The effect is modest but statistically meaningful.
:::
...
This path is negative and highly significant. Higher job satisfaction strongly reduces turnover intention. The effect size is large, and the confidence interval [-0.747, -0.327] confirms stability. This is the most important protective factor against turnover: satisfied teachers are much less likely to plan leaving.
:::
